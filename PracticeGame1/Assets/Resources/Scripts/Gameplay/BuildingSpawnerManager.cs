...
{
    private const string BUILDING_ASSET_PATH = "Prefabs/Buildings/Building09";
    ...
    private void SpawnBuildings()
    {
        ...
        for(int i = 0; i < numOfBuildingsToSpawn; i++)
        {
            ...
            GameObject building = Instantiate(Resources.Load(BUILDING_ASSET_PATH, typeof(GameObject))) as GameObject;
